...
import { BranchedTitle, CardButton, CardDescription, CardTitle, Cover, Description, Line1, Line2, LineHolder, SummaryContainer, TextWrapper, Title } from './styles'
...
export default function LearningSummary() {
  return (
    <SummaryContainer>
        ...
        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}style={{textAlign: '-webkit-center', marginTop:'20px'}} >
