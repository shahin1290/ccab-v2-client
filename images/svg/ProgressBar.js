...
const ProgressBar = ({ width = 1258, height = 119, stage, color }) => {
  if (stage < 1 || stage > 7) throw new Error("Stages must be between 1 & 7");
    ...
    >
      <g id="Progress">
        ...
        <motion.path
          ...
          initial="initial"
          animate={stage > 6 ? "visible" : "initial"}
        />
        <motion.path
          id="Stage4"
          ...
          variants={circleVariant}
          initial="initial"
          animate={stage > 3 ? "visible" : "initial"}
        />
        <motion.path
          id="Stage6"
          ...
          variants={circleVariant}
          initial="initial"
          animate={stage > 5 ? "visible" : "initial"}
        />
        <motion.path
          id="Stage3"
          ...
          variants={circleVariant}
          initial="initial"
          animate={stage > 2 ? "visible" : "initial"}
        />
        <motion.path
          id="Stage5"
          ...
          variants={circleVariant}
          initial="initial"
          animate={stage > 4 ? "visible" : "initial"}
        />
        <motion.path
          id="Stage2"
          ...
          variants={circleVariant}
          initial="initial"
          animate={stage > 1 ? "visible" : "initial"}
        />
        <motion.path
          id="Stage1"
